...
@client.tree.command(name="kick", description="Kick a member of the server", guild=discord.Object(id=main_guild))
...
@client.tree.command(name="ban", description="Ban a member of the server", guild=discord.Object(id=main_guild))
async def slash_command(interaction: discord.Interaction, member: discord.Member, reason: str):
    try:
        if reason == '':
            await interaction.response.send_message('*** Please provide a reason ***')
...
@client.tree.command(name="unban", description="Unban a member of the server", guild=discord.Object(id=main_guild))
async def slash_command(interaction: discord.Interaction, member: discord.Member, reason: str):
    try:
        if reason == '':
            await interaction.response.send_message('*** Please provide a reason ***')
...
@client.tree.command(name="ping", description="Check the bot's latency", guild=discord.Object(id=main_guild))
